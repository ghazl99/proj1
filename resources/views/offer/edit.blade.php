...
<body>
    ...
    <form method="POST" action="{{Route('offer.update',$off->id)}}" enctype="multipart/form-data">
        @csrf
        {{csrf_field()}}
        {{method_field('PUT')}}
        <div class="form-group">
            <label for="exampleInputEmail1">offer name</label>
            <input type="text" class="form-control" name="name" value="{{$off -> name}}" aria-describedby="emailHelp"
                placeholder="name">
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{$off -> price}}" name="price" placeholder="price">
            @error('price')
            <small id="emailHelp" class="form-text text-muted">{{$message}}</small>
            @enderror
        </div>
        ...
        <button type="submit" class="btn btn-primary">{{__('message.testmessage')}}</button>
    </form>
